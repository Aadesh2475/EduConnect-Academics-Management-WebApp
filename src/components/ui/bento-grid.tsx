            ...
            {items.map((item, index) => (
                <div
                    ...
                    className={cn(
                        ...
                        "border border-gray-100/80 dark:border-white/10 bg-white dark:bg-[#090909]",
                ...
                >
                    ...
                    <div className="relative flex flex-col space-y-3">
                        ...
                        <div className="flex items-center justify-between mt-2">
                            ...
                            <Link
                                href="/auth/login"
                                className="text-xs text-gray-500 dark:text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity hover:text-indigo-600 dark:hover:text-indigo-400"
                            >
                                {item.cta || "Explore →"}
                            </Link>
                        </div>
